...
# Actions: "", "turret", "wall", "miner", "mortar", "tesla", "shard_miner", "sniper"  # +sniper
...
func _is_valid_action(a: String) -> bool:
	return a == "turret" or a == "wall" or a == "miner" or a == "mortar" or a == "tesla" or a == "shard_miner" or a == "sniper"  # +sniper
